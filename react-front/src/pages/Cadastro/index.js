...
const CadastroProduto = () => {
  const [produto, setProduto] = useState({
    ...
    categoria: "",
    estoque: "",
    img: [], // Armazenará o arquivo da imagem
    reserva: "estoque", // Valor padrão para o campo de seleção
  });
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("visivel", produto.visivel);
    ...
    try {
      await api
        .post("/api/v1/produtos/createProduct", formData, {
          headers: {
          ...
          <form className="cadastro-form">
            ...
            <div className="form-group">
              ...
              />
               ...
               <div className="form-group">
              <label htmlFor="precoComDesconto">Preço com Desconto:</label>
              <input
                type="number"
                id="precoComDesconto"
